          ...
          <div class="container-xxl">
            <div class="py-3 d-flex align-items-sm-center flex-sm-row flex-column">
              <div class="flex-grow-1">
                <h4 class="fs-18 fw-semibold m-0">Edit Medicine</h4>
              </div>
            </div>
            ...
            <div class="row">
              <div class="col-xl-12">
                ...
                @endif
                                    ...
                                    <div class="card-body">
                                        <form class="row g-3" action="{{ route('medicines.update', $medicine->id) }}" method="POST">
                                            @csrf
                                            <div class="col-md-12">
                                                <label for="validationServer01" class="form-label">Name</label>
                                                <input type="text" name="name" class="form-control " id="" value="{{ $medicine->name }}" required placeholder="Name">
                                            </div>
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="input-group has-validation">
                                                    <input type="text" name="unit" class="form-control " id="" value="{{ $medicine->unit }}" required placeholder="Unit">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="input-group has-validation">
                                                    ...
                                                    <input type="Number" name="purchase_price" class="form-control " id="" value="{{ $medicine->purchase_price }}" required placeholder="Purchase Price">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="input-group has-validation">
                                                    ...
                                                    <input type="Number" name="selling_price" class="form-control " id="" value="{{ $medicine->selling_price }}" required placeholder="Selling Price">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="input-group has-validation">
                                                    ...
                                                    <input type="Number" name="stock_quantity" class="form-control " id="" value="{{ $medicine->stock }}" required placeholder="Stock Quantity">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="input-group has-validation">
                                                    <input type="Number" name="low_stock_threshold" class="form-control " id="" value="{{ $medicine->low_stock_threshold }}" required placeholder="Low Stock Threshold">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="input-group has-validation">
                                                    <input type="Date" name="expiry_date" class="form-control " id="" value="{{ $medicine->expiry_date }}"  placeholder="Expiry Date">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="input-group has-validation">
                                                    <input type="Text" name="description" class="form-control " id="" value="{{ $medicine->description }}"  placeholder="Description">
                                                </div>
                                            </div>
                                            <div class="col-md-6">
