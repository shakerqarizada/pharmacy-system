                  ...
                  <div class="noti-scroll" data-simplebar>
                    ...
                    >
                      <div class="notify-icon">
                        <img
                          src="backend/assets/images/users/user-12.jpg"
                    ...
                    >
                      <div class="notify-icon">
                        <img
                          src="backend/assets/images/users/user-2.jpg"
                          class="img-fluid rounded-circle"
                          alt=""
                        />
                      </div>
                    ...
                    >
                      <div class="notify-icon">
                        <img
                          src="backend/assets/images/users/user-3.jpg"
                          class="img-fluid rounded-circle"
                          alt=""
                        />
                      </div>
                    ...
                    >
                      <div class="notify-icon">
                        <img
                          src="backend/assets/images/users/user-8.jpg"
                          class="img-fluid rounded-circle"
                          alt=""
                        />
                      </div>
                    ...
                    >
                      <div class="notify-icon">
                        <img
                          src="backend/assets/images/users/user-5.jpg"
                          class="img-fluid rounded-circle"
                          alt=""
                        />
                      </div>
                    ...
                    >
                      <div class="notify-icon">
                        <img
                          src="backend/assets/images/users/user-6.jpg"
                          class="img-fluid rounded-circle"
                          alt=""
                        />
                      </div>
